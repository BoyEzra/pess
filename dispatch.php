...
$sql = "SELECT patrolcarid, statusDesc FROM patrolcar JOIN patrolcarstatus
ON patrolcar.patrolcarStatusid=patrolcarstatus.statusid
WHERE patrolcar.patrolcarStatusid";
...
if (isset($_POST["btnDispatch"]))
{
  ...
  $sql = "INSERT INTO incident (callerName, phoneNumber, incidentTypeId, incidentLocation, incidentDesc, incidentStatusId) VALUES('".$_POST['callerName']."', '".$_POST['contactNo']."', '".$_POST['incidentType']."', '".$_POST['location']."', '".$_POST['incidentDesc']."', $incidentStatus)";
  ...
  for($i=0; $i < $numOfPatrocarDispatched; $i++)
  {
	...
	$sql = "UPDATE patrolcar SET statusid='1' WHERE patrolcarid = '".$patrolcarDispatched[$i]."'";
